...
def _build_prompt(
    ...
    if include_image:
        ...
        Given the definitions of emotions above, evaluate if the input tweet and image would {"make the user feel" if personalized else "contain or express"} the following emotions: Nervous, Sad, Happy, Calm, Excited, Aroused, Angry, Relaxed, Fearful, Enthusiastic, Still, Satisfied, Bored, Lonely, Tired.
        ...
        content_instruction = f"""
        Given the definitions of emotions above, evaluate if the input tweet would {"make the user feel" if personalized else "contain or express"} the following emotions: Nervous, Sad, Happy, Calm, Excited, Aroused, Angry, Relaxed, Fearful, Enthusiastic, Still, Satisfied, Bored, Lonely, Tired.
        """
        input_description = f"""
        Input tweet: {tweet_text}
        """
